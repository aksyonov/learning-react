...
exports['default'] = (0, _reactLibKeyMirror2['default'])({
  SAVE_COMMENT_START: null,
  SAVE_COMMENT_SUCCESS: null,
  SAVE_COMMENT_ERROR: null
});
module.exports = exports['default'];

},{"react/lib/keyMirror":229}],2:[function(require,module,exports){
'use strict';
...
function submitComment(data) {
  _reactor2['default'].dispatch(_actionTypes.SAVE_COMMENT_START, data);
  setTimeout(function () {
    return _reactor2['default'].dispatch(_actionTypes.SAVE_COMMENT_SUCCESS, data);
  }, 1000);
}

},{"./action-types":1,"./getters":8,"./reactor":11}],3:[function(require,module,exports){
'use strict';
...
},{"./comment-box":4,"react":244}],4:[function(require,module,exports){
'use strict';
...
},{"./comment-form":5,"./comment-list":6,"react":244}],5:[function(require,module,exports){
'use strict';
...
var CommentForm = (function (_React$Component) {
  ...
  _createClass(CommentForm, [{
    ...
    value: function validateForm() {
      var author = _react2['default'].findDOMNode(this.refs.author).firstChild.value;
      var text = _react2['default'].findDOMNode(this.refs.text).firstChild.value;
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var author = _react2['default'].findDOMNode(this.refs.author).firstChild.value.trim();
      var text = _react2['default'].findDOMNode(this.refs.text).firstChild.value.trim();
      if (!this.validateForm()) return;
      (0, _actions.submitComment)({ author: author, text: text });
      _react2['default'].findDOMNode(this.refs.author).firstChild.value = '';
      _react2['default'].findDOMNode(this.refs.text).firstChild.value = '';
      this.handleChange();
    }
  }, {
    key: 'handleChange',
    ...
    value: function render() {
      return _react2['default'].createElement(
        'form',
        { className: 'commentForm', onSubmit: this.handleSubmit.bind(this), onChange: this.handleChange.bind(this) },
        _react2['default'].createElement(_reactBootstrapLibInput2['default'], { type: 'text', placeholder: 'Your name', ref: 'author' }),
        _react2['default'].createElement(_reactBootstrapLibInput2['default'], { type: 'text', placeholder: 'Say something...', ref: 'text' }),
        _react2['default'].createElement(_reactBootstrapLibButtonInput2['default'], { type: 'submit', value: 'Post', bsStyle: 'primary', disabled: this.state.disabled })
      );
    }
  }]);
...
},{"../actions":2,"react":244,"react-bootstrap/lib/Button":71,"react-bootstrap/lib/ButtonInput":72,"react-bootstrap/lib/Input":78}],6:[function(require,module,exports){
'use strict';
...
var _reactorComponent = require('../reactor-component');

var _reactorComponent2 = _interopRequireDefault(_reactorComponent);
...
var CommentList = (function (_ReactorComponent) {
  _inherits(CommentList, _ReactorComponent);
  ...
  _createClass(CommentList, [{
    key: 'getDataBindings',
    value: function getDataBindings() {
      return { comments: _getters.comments };
    }
  }, {
    key: 'render',
    value: function render() {
  ...
  return CommentList;
})(_reactorComponent2['default']);

exports['default'] = CommentList;
module.exports = exports['default'];

},{"../getters":8,"../reactor-component":10,"./comment":7,"react":244}],7:[function(require,module,exports){
'use strict';
  ...
  _createClass(Comment, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        { header: this.comment.author, bsStyle: this.comment.sending ? 'warning' : 'primary' },
...
},{"marked":68,"react":244,"react-bootstrap/lib/Panel":80}],8:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
var comments = [['comments'], function (comments) {
  return comments.toList().toJS();
}];
...
},{"./actions":2,"./components/app":3,"react":244}],10:[function(require,module,exports){
'use strict';
...
},{"./reactor":11,"react":244}],11:[function(require,module,exports){
'use strict';
...
var _storesComments = require('./stores/comments');

var _storesComments2 = _interopRequireDefault(_storesComments);

var reactor = new _nuclearJs.Reactor({ debug: true });

reactor.registerStores({
  comments: new _storesComments2['default']()
});

exports['default'] = reactor;
module.exports = exports['default'];

},{"./stores/comments":12,"nuclear-js":69}],12:[function(require,module,exports){
'use strict';
...
var CommentStore = (function (_Store) {
  _inherits(CommentStore, _Store);

  function CommentStore() {
    _classCallCheck(this, CommentStore);

    _get(Object.getPrototypeOf(CommentStore.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(CommentStore, [{
    ...
    value: function initialize() {
      this.on(_actionTypes.SAVE_COMMENT_START, this.commentSent);
      this.on(_actionTypes.SAVE_COMMENT_SUCCESS, this.finishSend);
      this.on(_actionTypes.SAVE_COMMENT_ERROR, this.rollback);
    }
  }, {
    key: 'commentSent',
    value: function commentSent(state, data) {
      data.sending = true;
      return state.push((0, _nuclearJs.toImmutable)(data));
    }
  }, {
    key: 'finishSend',
    value: function finishSend(state, data) {
      var id = state.findIndex(function (el) {
        return el.get('text') == data.text && el.get('author') == data.author;
      });
      return state.update(id, function (comment) {
        return comment.set('sending', false);
      });
    }
  }, {
    key: 'rollback',
    value: function rollback(state, data) {
      var id = state.findIndex(function (el) {
        return el.get('text') == data.text && el.get('author') == data.author;
      });
...
},{"../action-types":1,"nuclear-js":69}],13:[function(require,module,exports){
...
module.exports = exports['default'];
},{"./ownerDocument":49,"./util/babelHelpers.js":62}],48:[function(require,module,exports){
'use strict';
...
module.exports = on;
},{"../util/inDOM":67}],49:[function(require,module,exports){
"use strict";
...
module.exports = exports['default'];
},{"./ownerDocument":49,"./util/babelHelpers.js":62}],51:[function(require,module,exports){
'use strict';
var canUseDOM = require('../util/inDOM');
...
},{"../util/inDOM":67}],52:[function(require,module,exports){
'use strict';
...
},{"../ownerDocument":49,"./contains":51,"./isWindow":52}],54:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../ownerDocument":49,"../style":59,"../util/babelHelpers.js":62}],55:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../style":59,"../util/babelHelpers.js":62,"./offset":53,"./offsetParent":54,"./scrollLeft":56,"./scrollTop":57}],56:[function(require,module,exports){
'use strict';
...
},{"./isWindow":52}],57:[function(require,module,exports){
'use strict';
var getWindow = require('./isWindow');
...
},{"../util/babelHelpers.js":62,"../util/camelizeStyle":64}],59:[function(require,module,exports){
'use strict';
...
},{"../util/camelizeStyle":64,"../util/hyphenateStyle":66,"./getComputedStyle":58,"./removeStyle":60}],60:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./styleMaps":81,"./utils/CustomPropTypes":82,"babel-runtime/helpers/interop-require-default":20,"react":244}],71:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./BootstrapMixin":70,"./ButtonInput":72,"./utils/CustomPropTypes":82,"babel-runtime/helpers/extends":18,"babel-runtime/helpers/interop-require-default":20,"classnames":23,"react":244}],72:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./Button":71,"./FormGroup":76,"./InputBase":79,"./utils/childrenValueInputValidation":85,"babel-runtime/helpers/class-call-check":17,"babel-runtime/helpers/extends":18,"babel-runtime/helpers/inherits":19,"babel-runtime/helpers/interop-require-default":20,"babel-runtime/helpers/object-without-properties":22,"react":244}],73:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./utils/CustomPropTypes":82,"./utils/createChainedFunction":86,"./utils/deprecationWarning":87,"./utils/domUtils":88,"babel-runtime/helpers/class-call-check":17,"babel-runtime/helpers/extends":18,"babel-runtime/helpers/inherits":19,"babel-runtime/helpers/interop-require-default":20,"react":244,"react-overlays/lib/Transition":89}],74:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"../InputBase":79,"../utils/childrenValueInputValidation":85,"babel-runtime/helpers/class-call-check":17,"babel-runtime/helpers/extends":18,"babel-runtime/helpers/inherits":19,"babel-runtime/helpers/interop-require-default":20,"classnames":23,"react":244}],75:[function(require,module,exports){
'use strict';
...
},{"./Static":74,"babel-runtime/helpers/interop-require-default":20}],76:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"babel-runtime/helpers/class-call-check":17,"babel-runtime/helpers/inherits":19,"babel-runtime/helpers/interop-require-default":20,"classnames":23,"react":244}],77:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"babel-runtime/helpers/extends":18,"babel-runtime/helpers/interop-require-default":20,"classnames":23,"react":244}],78:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./FormControls":75,"./InputBase":79,"./utils/deprecationWarning":87,"babel-runtime/helpers/class-call-check":17,"babel-runtime/helpers/inherits":19,"babel-runtime/helpers/interop-require-default":20,"babel-runtime/helpers/interop-require-wildcard":21,"react":244}],79:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./FormGroup":76,"./Glyphicon":77,"babel-runtime/helpers/class-call-check":17,"babel-runtime/helpers/extends":18,"babel-runtime/helpers/inherits":19,"babel-runtime/helpers/interop-require-default":20,"classnames":23,"react":244}],80:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./BootstrapMixin":70,"./Collapse":73,"babel-runtime/helpers/extends":18,"babel-runtime/helpers/interop-require-default":20,"babel-runtime/helpers/object-without-properties":22,"classnames":23,"react":244}],81:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./childrenToArray":84,"babel-runtime/core-js/object/keys":15,"babel-runtime/helpers/interop-require-default":20,"react":244,"react/lib/warning":243}],83:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"babel-runtime/helpers/interop-require-default":20,"react":244}],84:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./ValidComponentChildren":83,"babel-runtime/helpers/interop-require-default":20}],85:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"./CustomPropTypes":82,"babel-runtime/helpers/interop-require-default":20,"react":244}],86:[function(require,module,exports){
/**
...
module.exports = exports['default'];
},{"babel-runtime/helpers/class-call-check":17,"babel-runtime/helpers/inherits":19,"babel-runtime/helpers/interop-require-default":20,"react/lib/warning":243}],88:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"babel-runtime/helpers/interop-require-default":20,"dom-helpers/activeElement":47,"dom-helpers/ownerDocument":49,"dom-helpers/ownerWindow":50,"dom-helpers/query/contains":51,"dom-helpers/query/offset":53,"dom-helpers/query/offsetParent":54,"dom-helpers/query/position":55,"dom-helpers/style":59,"dom-helpers/util/inDOM":67,"react":244}],89:[function(require,module,exports){
'use strict';
...
},{"classnames":23,"dom-helpers/events/on":48,"dom-helpers/transition/properties":61,"react":244}],90:[function(require,module,exports){
/**
